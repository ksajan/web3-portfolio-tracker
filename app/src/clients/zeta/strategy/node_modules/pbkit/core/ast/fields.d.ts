...
import { Comma, Constant, Empty, IntLit, Keyword, Semi, Type } from "./lexical-elements";
import { MessageBody } from "./top-level-definitions";
export declare type Node = Field | MalformedField | FieldOptions | FieldOption | Group | Oneof | OneofBody | OneofField | OneofGroup | MapField;
...
export declare type MalformedField = MalformedBase<Field, "malformed-field", "fieldLabel" | "fieldType">;
...
export declare type OneofBodyStatement = Option | OneofField | OneofGroup | Empty;
