...
import { Field, FieldOptions, Group, MalformedField, MapField, Oneof } from "./fields";
import { Option, StatementBase } from "./index";
import { Empty, Keyword, Semi, SignedIntLit, Type } from "./lexical-elements";
export declare type Node = Enum | EnumBody | EnumField | Message | MessageBody | Extend | ExtendBody | Service | ServiceBody | Rpc | RpcBody;
...
export declare type EnumBodyStatement = Option | Reserved | EnumField | Empty;
...
export declare type MessageBodyStatement = Field | MalformedField | Enum | Message | Extend | Extensions | Group | Option | Oneof | MapField | Reserved | Empty;
...
export declare type ExtendBodyStatement = Field | MalformedField | Group | Empty;
...
export declare type ServiceBodyStatement = Option | Rpc | Empty;
...
export declare type RpcBodyStatement = Option | Empty;
