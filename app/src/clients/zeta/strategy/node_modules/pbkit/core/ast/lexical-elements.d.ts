...
export declare type Node = CommentGroup | SinglelineComment | MultilineComment | Keyword | Type | FullIdent | Ident | Dot | Comma | Semi | IntLit | SignedIntLit | FloatLit | SignedFloatLit | BoolLit | StrLit | Aggregate | Empty;
export interface CommentGroup extends Span {
    type: "comment-group";
    comments: Comment[];
}
export declare type Comment = SinglelineComment | MultilineComment;
...
export declare type Constant = FullIdent | SignedIntLit | SignedFloatLit | StrLit | BoolLit | Aggregate;
