...
export declare type WireMessage = [FieldNumber, Field][];
export declare type FieldNumber = number;
export declare type Field = Varint | Fixed64 | LengthDelimited | StartGroup | EndGroup | Fixed32;
