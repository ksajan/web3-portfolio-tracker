import { Field, LengthDelimited } from "./index";
declare type WireValueToTsValue<T> = (wireValue: Field) => T | undefined;
declare type TsValueToWireValue<T> = (tsValue: T) => Field;
declare type Unpack<T> = (wireValues: Iterable<Field>) => Generator<T>;
declare type Pack<T> = (values: T[]) => LengthDelimited;
...
declare type VarintFieldToTsValueFns = typeof varintFieldToTsValueFns;
...
declare type TsValueToVarintFieldFns = typeof tsValueToVarintFieldFns;
